  ...
  return (
    <div className='flex min-h-screen'>
        <section className='bg-brand p-10 hidden w-1/2 items-center justify-center lg:flex xl:w-2/5'>
            <div className='flex max-h-[800px] maw-w[430px] flex-col justify-center space-y-12'>
                <Image src="/assets/icons/logo-full.svg" alt="logo" width={240} height={82}
                className='h-auto'/>
                <div className='space-y-5 text-white'>
                    <h1 className='h1'> Manage your foles the best way</h1>
                    <p className='body-1'>
                        This is a place wher you can store all your documents
                    </p>
                </div>
